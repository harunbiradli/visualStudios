...
{
    public partial class mtakip : Form
    {
        public mtakip()
        {
            InitializeComponent();
        ...
        private void button2_Click(object sender, EventArgs e)   ///ana menü müdür
        {
        ...
        private void button1_Click(object sender, EventArgs e)   ///yenileme butonu
        {
            mahkumverigöster();
        }
    }
